...
class Vegetable: Decodable {
    ...
    var localizedName: String {
        NSLocalizedString("vegetable_\(vegetableId)_name".localized, comment: "Name of vegetable \(vegetableId)")
        }
        var localizedDescription: String {
            NSLocalizedString("vegetable_\(vegetableId)_description".localized, comment: "Description of vegetable \(vegetableId)")
        }
        var localizedHealthBenefits: String {
            NSLocalizedString("vegetable_\(vegetableId)_healthBenefits".localized, comment: "Health benefits of vegetable \(vegetableId)")
        }
        var localizedGrowingDescription: String {
            NSLocalizedString("vegetable_\(vegetableId)_growingDescription".localized, comment: "Growing description of vegetable \(vegetableId)")
        }
        var localizedHarvestDescription: String {
            NSLocalizedString("vegetable_\(vegetableId)_harvestDescription".localized, comment: "Harvest description of vegetable \(vegetableId)")
        }
    
    var localizedSeedDepth: String {
        NSLocalizedString("vegetable_\(vegetableId)_seedDepth".localized, comment: "Seed depth for vegetable \(vegetableId)")
    }

    var localizedWatering: String {
        NSLocalizedString("vegetable_\(vegetableId)_watering".localized, comment: "Watering info for vegetable \(vegetableId)")
    }

    var localizedLight: String {
        NSLocalizedString("vegetable_\(vegetableId)_light".localized, comment: "Light requirement for vegetable \(vegetableId)")
    }

    var localizedGoodCompanions: String {
        NSLocalizedString("vegetable_\(vegetableId)_goodCompanions".localized, comment: "Good companions for vegetable \(vegetableId)")
    }

    var localizedBadCompanions: String {
        NSLocalizedString("vegetable_\(vegetableId)_badCompanions".localized, comment: "Bad companions for vegetable \(vegetableId)")
    }
